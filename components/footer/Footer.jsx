...
const Footer = () => {
  return (
    <div className="bg-[#212529]">
      <footer className="grid footer grid-cols-12 p-10 container mx-auto bg-[#212529] text-white mt-10">
        <aside className="lg:col-span-3 col-span-6">
          <Image src={logo} height={55} width={185} alt="logo" />
          <div className="font-normal text-sm">
            Got Question? Call us 24/7 <br />
            <span className="inline-block my-2 text-base font-semibold">
              +02 055 4156
            </span>
            <br />
            Register now & get you 10% offer from first order!
          </div>
          <h6 className="text-base font-semibold footer-title">Join Us</h6>
        ...
        <nav className="lg:col-span-3 col-span-6">
